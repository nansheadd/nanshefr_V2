...
export const getTheme = (mode = 'dark') => {
  ...
  let theme = createTheme({
    palette: {
      ...
      background: {
        default: isDark ? palette.navy : '#f9f9fb',
        paper: isDark ? '#171a34' : '#ffffff'
      },
      text: {
        primary: isDark ? palette.white : palette.navy,
        secondary: isDark ? '#C9C9D5' : '#555555'
      }
    },
    ...
    components: {
      ...
      MuiLink: {
        styleOverrides: { root: { color: palette.peach, fontWeight: 600 } }
      }
    }
  });
